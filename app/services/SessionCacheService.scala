...
class SessionCacheService @Inject() (sessionCacheRepository: SessionCacheRepository) {
  ...
  def writeGroupNameAndRedirect(
    name: String
  )(call: Call)(implicit request: Request[_], hc: HeaderCarrier, ec: ExecutionContext) =
    for {
