...
trait AgentPermissionsConnectorMocks extends AnyWordSpec with MockFactory {
  ...
  def expectCreateGroupSuccess(arn: Arn, groupRequest: GroupRequest)(implicit
    agentPermissionsConnector: AgentPermissionsConnector
  ): Unit =
    (agentPermissionsConnector
      .createGroup(_: Arn)(_: GroupRequest)(_: HeaderCarrier, _: ExecutionContext))
  ...
  def expectGetGroupSummarySuccess(arn: Arn, summaries: Seq[GroupSummary])(implicit
    agentPermissionsConnector: AgentPermissionsConnector
  ): Unit =
    (agentPermissionsConnector
  ...
  def expectGetUnassignedClientsSuccess(
    arn: Arn,
  ...
  def expectGetGroupsForClientSuccess(arn: Arn, enrolmentKey: String, groups: Seq[GroupSummary])(implicit
    agentPermissionsConnector: AgentPermissionsConnector
  ): Unit =
    (agentPermissionsConnector
  ...
  def expectGetGroupsForTeamMemberSuccess(arn: Arn, agentUser: AgentUser, groups: Option[Seq[GroupSummary]])(implicit
    agentPermissionsConnector: AgentPermissionsConnector
  ): Unit =
    (agentPermissionsConnector
  ...
  def expectGetGroupSuccess(id: GroupId, group: Option[CustomGroup])(implicit
    agentPermissionsConnector: AgentPermissionsConnector
  ): Unit =
    (agentPermissionsConnector
  ...
  def expectGroupNameCheckError(arn: Arn, name: String)(implicit
    agentPermissionsConnector: AgentPermissionsConnector
  ): Unit =
    (agentPermissionsConnector
      .groupNameCheck(_: Arn, _: String)(_: HeaderCarrier, _: ExecutionContext))
