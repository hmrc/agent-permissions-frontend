...
trait SessionServiceMocks extends AnyWordSpec with MockFactory {
  ...
  def expectGetSessionItem[T](key: DataKey[T], mockedResponse: T, times: Int = 1)(implicit
    ...
    (service
      .get(_: DataKey[T])(_: Reads[T], _: Request[?]))
      .expects(key, *, *)
