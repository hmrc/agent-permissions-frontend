...
common.total.clients.selected=o gleientiaid wedi’u dewis ar draws pob chwiliad
common.singular.clients.selected=cleient wedi’i ddewis ar draws pob chwiliad
common.plural.clients.selected=o gleientiaid wedi’u dewis ar draws pob chwiliad
common.total.clients=Yn dangos cyfanswm o <strong>{0}</strong> o gleientiaid
common.total.selected=Wedi dewis
common.total.team-members.selected=o aelodau tîm wedi’u dewis ar draws pob chwiliad
common.singular.team-members.selected=aelod o’r tîm ar draws pob chwiliad
common.plural.team-members.selected=o aelodau tîm wedi’u dewis ar draws pob chwiliad
...
group.client.list.table.checkbox.label-missing-reference=Cyfeirnod treth {0}, Gwasanaeth treth {1}
group.client.list.table.th=Dewiswch cleient
...
group.client.review.remove.error=Dewiswch ‘Iawn’ os nad ydych am ychwanegu’r cleient hwn at y grŵp mynediad mwyach
...
common.showing.results.many.one=Yn dangos cyfanswm o 1 canlyniad {0}
common.showing.results.many.range=Yn dangos canlyniad {0} i {1} allan o {2} ar gyfer {3}
common.showing.results.many.total=Yn dangos cyfanswm o {0} o ganlyniadau {1}
...
group.tax-service.answer.label=Ychwanegu cleientiaid newydd at y grŵp mynediad hwn yn awtomatig?
group.tax-service.h1=Grwpiau mynediad ar sail gwasanaeth treth
group.tax-service.review.error=Dewiswch ‘Iawn’ os hoffech greu grŵp o’r math hwn
...
group.teamMembers.review.error.no-members=Rydych wedi dileu pob aelod o’r tîm, dewiswch o leiaf un i fynd yn eich blaen
...
member.added.to.groups.h1={0} wedi’i ychwanegu at grwpiau mynediad
...
paginated.title.page.of=(tudalen {0} o {1})
paginated.showing.total.filter-preposition=am yr
paginated.showing.total.filter-conjunction=a
paginated.clients.showing=Yn dangos {0} i {1} o {2} o gleientiaid
paginated.clients.showing.one=Yn dangos cyfanswm o 1 cleient {0}
paginated.clients.showing.range=Yn dangos {0} i {1} o gleientiaid, allan o {2} ar gyfer {3}
paginated.clients.showing.total=Yn dangos cyfanswm o {0} o gleientiaid {1}
paginated.clients.showing.tax-group.one=Yn dangos cyfanswm o 1 cleient {0}
paginated.clients.showing.tax-group.range=Yn dangos {0} i {1} o {2} o gleientiaid {3}
paginated.clients.showing.tax-group.total=Yn dangos cyfanswm o {0} o gleientiaid {1}
paginated.team-members.showing.one=Yn dangos cyfanswm o 1 aelod o’r tîm {0}
paginated.team-members.showing.range=Yn dangos {0} i {1} o aelodau’r tîm, allan o {2} ar gyfer {3}
paginated.team-members.showing.total=Yn dangos cyfanswm o {0} aelod o’r tîm {1}
paginated.access-groups.showing.one=Yn dangos cyfanswm o 1 grŵp mynediad {0}
paginated.access-groups.showing.range=Yn dangos {0} i {1} o {2} o grwpiau mynediad {3}
paginated.access-groups.showing.total=Yn dangos cyfanswm o {0} o grwpiau mynediad {1}
paginated.navigationLabel=Rhifo tudalennau
paginated.currentPageLabel=Tudalen {0} o {1}, y dudalen bresennol
paginated.pageLabel=Tudalen {0} o {1}
...
tax-group.manage.removed.clients.h2.total=Yn dangos {0} o gleientiaid {1} sydd wedi’u dileu
tax-group.manage.removed.clients.h2.one=Yn dangos 1 cleient {0} {1} sydd wedi’i dynnu
...
tax-service.pillar2=Rhoi gwybod am drethi atodol Colofn 2
...
unassigned.client.assign.none-of-the-above=Dim grwpiau mynediad
unassigned.client.assign.none-of-the-above.hint=Bydd hyn yn mynd â chi yn ôl i’r dudalen ‘Rheoli cyfrif’
unassigned.client.assign.invalid-selection.error=Dewiswch o leiaf un grŵp mynediad neu Dim grwpiau mynediad
