...
class CgtRefSpec extends AnyFlatSpec with Matchers {
  ...
  it should "parse json as model correctly" in {
    val expectedModel: CgtRef = CgtRef("XMCGTP123456789")
    val json = Json.obj("value" -> "XMCGTP123456789")

    json.as[CgtRef] shouldBe expectedModel
  }
