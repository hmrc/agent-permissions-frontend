...
@Singleton
class AgentPermissionsConnectorImpl @Inject() (val http: HttpClient)(implicit
  val metrics: Metrics,
  appConfig: AppConfig,
  ...
  private def deleteAccessGroup(url: String)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[Done] =
